        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-3 col-md-6">
                    ...
                    <h1 class="logo" style="color: #5633a8; font-weight: bold;">Retailo</h1>
                    <p style="color: #000000; font-weight: bold;">Welcome, Admin! Please login to access the admin portal.</p>
                        <!-- Form -->
